...
<style>
    ...
    #basic-addonr_1,#basic-addonr_2,#basic-addonr_3,#basic-addonr_4,#basic-addonr_5,#basic-addonr_6,#basic-addonr_7,#basic-addonr_8{
        color: lawngreen;
        background: url(images/bg.jpg) repeat;
        border: 0px;
    }
...
<div id="myModar" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLaber">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form id="register" action="/registServlet" method="post">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                ...
                <div class="modal-body">
                    <div class="input-group">
                        <span class="input-group-addon" id="basic-addonr0">昵&emsp;&emsp;称</span>
                        <input type="text" class="form-control" placeholder="请输入昵称" aria-describedby="basic-addonr0" id="rgtname" name="blogname">
                        <span class="input-group-addon" id="basic-addonr_1">&emsp;</span>
                    </div>

                    <p></p>
                    <div class="input-group">
                        <span class="input-group-addon" id="basic-addonr1">密&emsp;&emsp;码</span>
                        <input type="password" class="form-control" placeholder="请输入密码" aria-describedby="basic-addonr1" id="setpass" name="password">
                        <span class="input-group-addon" id="basic-addonr_2">&emsp;</span>
                    </div>
                    <p></p>
                    <div class="input-group">
                        <span class="input-group-addon" id="basic-addonr2">确认密码</span>
                        <input type="password" class="form-control" placeholder="请重新输入密码" aria-describedby="basic-addonr2" id="conpass">
                        <span class="input-group-addon" id="basic-addonr_3">&emsp;</span>

                    </div>
                    <p></p>
                    <div class="input-group">
                        <span class="input-group-addon" id="basic-addonr3">姓&emsp;&emsp;名</span>
                        <input type="text" class="form-control" placeholder="请输入姓名" aria-describedby="basic-addonr3" name="name">
                        <span class="input-group-addon" id="basic-addonr_4">&emsp;</span>
                    </div>

                    <p></p>

                    <div class="input-group">
                        <span class="input-group-addon" id="basic-addonr4">性&emsp;&emsp;别</span>&emsp;&emsp;&emsp;
                        <div class="form-control" aria-describedby="basic-addonr4" style="margin-top:-20px">
                            <span >男</span>&ensp;
                            <input type="radio" name="sex" checked >&emsp;&emsp;&emsp;
                            <span >女</span>&ensp;
                            <input type="radio" name="sex">
                        </div>
                        <span class="input-group-addon" id="basic-addonr_5">&emsp;</span>
                    </div>

                    <p></p>
                    <div class="input-group">
                        <span class="input-group-addon" id="basic-addonr5">地&emsp;&emsp;址</span>
                        <input type="text" class="form-control" placeholder="请输入地址" aria-describedby="basic-addonr5" name="address">
                        <span class="input-group-addon" id="basic-addonr_6">&emsp;</span>
                    </div>
                    <p></p>
                    <div class="input-group">
                        <span class="input-group-addon" id="basic-addonr6">Q&ensp;&emsp;&emsp;Q</span>
                        <input type="text" class="form-control" placeholder="请输入qq" aria-describedby="basic-addonr7" name="qq">
                        <span class="input-group-addon" id="basic-addonr_7">&emsp;</span>
                    </div>
                    <p></p>
                    <div class="input-group">
                        <span class="input-group-addon" id="basic-addonr7">邮&emsp;&emsp;箱</span>
                        <input type="text" class="form-control" placeholder="请输入邮箱" aria-describedby="basic-addonr7" name="email">
                        <span class="input-group-addon" id="basic-addonr_8">&emsp;</span>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-warning" data-dismiss="modal">返回</button>
...
<script type="text/javascript">
    $(function () {
        $("#rgtname").blur(function () {
            $.post("/fnameServlet",{blogname:this.value},function (resp) {
                if (resp.res){

                    $("#rgtname").next().empty().html("<span class='glyphicon glyphicon-ok'></span>");
                }else {
                    $(this).next().html("<span class='glyphicon glyphicon-remove'></span>");
                }
            })
        })
        $("#conpass").blur(function () {
            if ($("#conpass").val()==($("#setpass").val())&$("#conpass").val()!=""){
                $("#setpass").next().empty().html("<span class='glyphicon glyphicon-ok'></span>");
                $("#conpass").next().empty().html("<span class='glyphicon glyphicon-ok'></span>");
            }else {
                $("#setpass").next().empty().html("<span class='glyphicon glyphicon-remove'></span>");
                $("#conpass").next().empty().html("<span class='glyphicon glyphicon-remove'></span>");
            }
        })

        $(":text").blur(function () {
            if ($(this).val()==""){
                $(this).next().empty().html("<span class='glyphicon glyphicon-remove'></span>");
            } else {
                $(this).next().empty().html("<span class='glyphicon glyphicon-ok'></span>");
            }
        })
        $(":radio").click(function () {
            $("#basic-addonr_5").empty().html("<span class='glyphicon glyphicon-ok'></span>");
        })
    })
</script>
...
<div class="topnav">
    ...
    <div class="row">
        ...
        <div class="col-md-2" id="log_regroup">
        ...
        <div class="col-md-2" id="photo" hidden="hidden">
            <img id="p" style="height:40px;width:40px;display:inline-block"class="img-circle">
            <span id="w" style="color: white"></span>
        </div>
    </div>
